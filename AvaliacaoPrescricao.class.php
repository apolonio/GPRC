...
class AvaliacaoPrescricao extends TStandardForm
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Prescrição do Paciente');
...
//        $id                              = new TEntry('id');
        ...
        $lbl_hiperArterial = new TLabel('Hipertensão');
        ...
        $frequencia->setSize(40);

        $lbl_frequencia = new TLabel('Frequência');
        $lbl_frequencia->setSize(120);
        $lbl_frequencia2 = new TLabel('Vezes por Semana');
        $lbl_frequencia2->setSize(200);
        ...
        /*
         * Treinamento Resistido: Carga em Joules
         */
        ...
        $squat->setSize(50);
          ...
          /*
         * Treinamento Resistido: Carga Percentual
         */
        ...
        */
        ...
        $squatR->setSize(50);
         /*
         * Treinamento Resistido: Frequencia Inicial
         */
         ...
         * Treinamento Resistido: Frequencia Inicial
         */
        $lowbackF = new TEntry('lowbackF');
        $lowbackF->setSize(50);
        $abdominalF = new TEntry('abdominalF');
        $abdominalF->setSize(50);
        $chestpressF = new TEntry('chestpressF');
        $chestpressF->setSize(50);
        $pulldownF = new TEntry('pulldownF');
        $pulldownF->setSize(50);
        $shoulderpressF = new TEntry('shoulderpressF');
        $shoulderpressF->setSize(50);
        $tricepsdipsF = new TEntry('tricepsdipsF');
        $tricepsdipsF->setSize(50);
        $totalhipF = new TEntry('totalhipF');
        $totalhipF->setSize(50);
        $legextensionF = new TEntry('legextensionF');
        $legextensionF->setSize(50);
        $abductionF = new TEntry('abductionF');
        $abductionF->setSize(50);
        $adductionF = new TEntry('adductionF');
        $adductionF->setSize(50);
        $seatedlegcurlF = new TEntry('seatedlegcurlF');
        $seatedlegcurlF->setSize(50);
        $seatedlegpressF = new TEntry('seatedlegpressF');
        $seatedlegpressF->setSize(50);
        $squatF = new TEntry('squatF');
        $squatF->setSize(50);
  /*
         * Treinamento Resistido: Escala
         */
        $lowbackE = new TEntry('lowbackE');
        $lowbackE->setSize(50);
        $abdominalE = new TEntry('abdominalE');
        $abdominalE->setSize(50);
        $chestpressE = new TEntry('chestpressE');
        $chestpressE->setSize(50);
        $pulldownE = new TEntry('pulldownE');
        $pulldownE->setSize(50);
        $shoulderpressE = new TEntry('shoulderpressE');
        $shoulderpressE->setSize(50);
        $tricepsdipsE = new TEntry('tricepsdipsE');
        $tricepsdipsE->setSize(50);
        $totalhipE = new TEntry('totalhipE');
        $totalhipE->setSize(50);
        $legextensionE = new TEntry('legextensionE');
        $legextensionE->setSize(50);
        $abductionE = new TEntry('abductionE');
        $abductionE->setSize(50);
        $adductionE = new TEntry('adductionE');
        $adductionE->setSize(50);
        $seatedlegcurlE = new TEntry('seatedlegcurlE');
        $seatedlegcurlE->setSize(50);
        $seatedlegpressE = new TEntry('seatedlegpressE');
        $seatedlegpressE->setSize(50);
        $squatE = new TEntry('squatE');
        $squatE->setSize(50);

        //Label do Treinamento Resistido
        ...
        $lbl_squat->setSize(130); 
          ...
          //Objetivo Funcional
          $lbl_mcc = new TLabel('Melhorar a Cap. Cardiorespiratória');
          $lbl_mcc->setSize(150);
          $lbl_dlv = new TLabel('Diminuir a Limitação Ventilatória');
          $lbl_dlv->setSize(150);
          $lbl_afme = new TLabel('Aumentar a Força Muscular Esquelética');
          $lbl_afme->setSize(150);
          ...
          $lbl_flexibilidade= new TLabel('Aumentar a Flexibilidade');
          $lbl_flexibilidade->setSize(150);
        ...
        $row->addCell( new TLabel('Objetivos Clínicos'))->colspan = 2;

        $this->form->addQuickFields('- ', array($lbl_hiperArterial, $hiperArterial, $lbl_dispineia, $dispineia, $lbl_obesidade, $obesidade, $lbl_depressao, $depressao  ));
        $this->form->addQuickFields('- ', array($lbl_angina, $angina,  $lbl_dislipidemia, $dislipidemia,$lbl_tabagismo, $tabagismo,  $lbl_estresse, $estresse));
        

        $row = $this->form->addRow();
        $row->class = 'tformsection';
        $row->addCell( new TLabel('Objetivos Funcionais'))->colspan = 2;

  

        $this->form->addQuickFields('-', array($lbl_mcc,$cardio, $lbl_dlv, $dlv,$lbl_afme ,$afme));
        $this->form->addQuickFields('-', array($lbl_me,$me,$lbl_fmr, $fmr, $lbl_ddo,$ddo));
        $this->form->addQuickFields('-', array( $lbl_flexibilidade,$af));
        
        $row = $this->form->addRow();
        $row->class = 'tformsection';
        $row->addCell( new TLabel('PRESCRIÇÕES'))->colspan = 2;

        $row = $this->form->addRow();
        $row->class = 'tformsection';
        $row->addCell( new TLabel('Exercício Aeróbico'))->colspan = 2;
       
        $this->form->addQuickFields('-', array($lbl_frequencia, $frequencia, $lbl_frequencia2));  
        ...
        $row = $this->form->addRow();
        $row->class = 'tformsection';
        $row->addCell( new TLabel('TREINAMENTO RESISTIDO -------------------------------------------------------------- Carga | -----  (%)  --- Série ----- Repetição - FCi --- FCs ---- Escala'))->colspan = 2;
        
        $this->form->addQuickFields('', array($lbl_lowback, $lowback, $lowback2,$lowbackR, $lowbackI, $lowbackS, $lowbackE, $lowbackF)); 
        $this->form->addQuickFields('', array($lbl_abdominal, $abdominal, $abdominal2, $abdominalR,$abdominalI, $abdominalS, $abdominalE, $abdominalF)); 
        $this->form->addQuickFields('', array($lbl_chestpress, $chestpress, $chestpress2, $chestpressR, $chestpressI, $chestpressS,$chestpressE, $chestpressF)); 
        $this->form->addQuickFields('', array($lbl_pulldown, $pulldown, $pulldown2, $pulldownR, $pulldownI, $pulldownS,$pulldownE, $pulldownF)); 
        $this->form->addQuickFields('', array($lbl_shoulderpress, $shoulderpress,$shoulderpress2, $shoulderpressR, $shoulderpressI, $shoulderpressS, $shoulderpressE, $shoulderpressF)); 
     
        $this->form->addQuickFields('Treinamento Resistido', array($lbl_tricepsdips, $tricepsdips, $tricepsdips2, $tricepsdipsR, $tricepsdipsI, $tricepsdipsS, $tricepsdipsE, $tricepsdipsF)); 
        $this->form->addQuickFields('', array($lbl_totalhip, $totalhip, $totalhip2, $totalhipR, $totalhipI, $totalhipS,$totalhipE, $totalhipF)); 

        $this->form->addQuickFields('', array($lbl_legextension, $legextension, $legextension2, $legextensionR, $legextensionI, $legextensionS,$legextensionE, $legextensionF)); 
        $this->form->addQuickFields('', array($lbl_abduction, $abduction, $abduction2, $abductionR, $abductionI, $abductionS,$abductionE, $abductionF));

        $this->form->addQuickFields('', array($lbl_adduction, $adduction, $adduction2, $adductionR, $adductionI, $adductionS, $adductionE, $adductionF )); 
        $this->form->addQuickFields('', array($lbl_seatedlegcurl, $seatedlegcurl, $seatedlegcurl2, $seatedlegcurlR, $seatedlegcurlI, $seatedlegcurlS,$seatedlegcurlE, $seatedlegcurlF)); 

        $this->form->addQuickFields('', array($lbl_seatedlegpress, $seatedlegpress, $seatedlegpress2, $seatedlegpressR, $seatedlegpressI, $seatedlegpressS,$seatedlegpressE, $seatedlegpressF)); 
        $this->form->addQuickFields('', array($lbl_squat, $squat,$squat2, $squatR, $squatI, $squatS,$squatE, $squatF)); 
        $row = $this->form->addRow();
        $row->class = 'tformsection';
    ...
    public function onSave()
    {
        ...
        if ($object instanceof Prescricao)
        {
                try
                {
                    ...
                    new TMessage('info', 'Avaliação e Prescrição realizada com Sucesso!');
                     TTransaction::close();
                }
                catch (Exception $e)
                {
