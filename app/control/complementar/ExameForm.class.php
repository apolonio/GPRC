<?php
/**
 * @class      ExameForm  Esse exame permite enviar um arquivos de upload
 * @version    1.0
 * @package    icriacoes
 * @subpackage gprc 
 ...
 */
class ExameForm extends TStandardForm
{
    protected $form;     
    private $loaded;
    private $frame;
    ...
    public function __construct()
    {
        ...
        $codExameItem   = new TEntry('codExameItem');
        ...
        $this->form->addQuickField('CodExame', $codExameItem,  50);
    ...
    function onReload($param = NULL)
    {
        try
        {
            ...
            $order    = isset($param['order']) ? $param['order'] : 'codExameItem';
