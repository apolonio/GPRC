 ...
 */
class TreinamentoResistidoForm extends TStandardForm
{
    protected $form;
    ...
    {
        parent::__construct();
        $this->form = new TQuickForm('form_edicaotr');
        $this->form->class = 'tform'; 
        $this->form->style = 'width: 700px;';
        $this->form->setFormTitle('Treinamento Resistido' );
        parent::setDatabase('permission'); 
        parent::setActiveRecord('AvaliacaoTreinamentoResistido');
        
        $codTr                             = new TEntry('codTr');
        ...
        $codTr->setEditable( FALSE );
        // Campos que aparecem no Formulário
        $this->form->addQuickField('ID',$codTr,100);
        ...
        $this->form->addQuickAction(_t('Find'), new TAction(array('PesquisaTreinamentoResistido', 'onReload')), 'ico_back.png');

        
        $vbox = new TVBox;
        $vbox->add(new TXMLBreadCrumb('menu.xml', 'PesquisaTreinamentoResistido'));
        $vbox->add($this->form);
