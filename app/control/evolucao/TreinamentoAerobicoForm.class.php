<?php
/**
 * @class:     TreinamentoResistidoForm = Responsável pela edição do formulário
 * @version    1.0
 * @package    icriacoes
 * @subpackage gprc
 ...
 */
class TreinamentoAerobicoForm extends TStandardForm
{
    protected $form;
    ...
    {
        parent::__construct();
        $this->form = new TQuickForm('form_aerobico');
        $this->form->class = 'tform'; 
        $this->form->style = 'width: 100%;';
        $this->form->setFormTitle('Treinamento Aeróbico' );
        parent::setDatabase('permission'); 
        parent::setActiveRecord('AvaliacaoTreinamentoAerobico');
        
        $codAerobico    = new TEntry('codAerobico');
        ...
        $codAerobico->setEditable( FALSE );
        
        // Campos que aparecem no Formulário
        $this->form->addQuickField('ID',$codAerobico,100);
        ...
        $this->form->addQuickField('Data Tr. Aeróbico',$dataAerobico,100);
        $parecer->setSize(400, 70);
        
        
        $this->form->addQuickAction(_t('Save'), new TAction(array($this, 'onSave')), 'ico_save.png');
        $this->form->addQuickAction(_t('Find'), new TAction(array('PesquisaTreinamentoAerobico', 'onReload')), 'ico_back.png');

        $vbox = new TVBox;
        $vbox->add(new TXMLBreadCrumb('menu.xml', 'PesquisaTreinamentoAerobico'));
        $vbox->add($this->form);
     ...
     * Atualiza o Registro na tabela system_treinamento_resistido
     */
