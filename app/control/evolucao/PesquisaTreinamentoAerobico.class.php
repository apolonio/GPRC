 ...
 */
class PesquisaTreinamentoAerobico extends TStandardList
{
    protected $form;    
    protected $datagrid; 
    ...
    public function __construct()
    {
        ...
        parent::setDefaultOrder('codAerobico', 'desc');         
        ...
        $this->form->setFormTitle('Pesquisa Treinamento Aeróbico');
     ...
     //   $this->form->addQuickField('Modalidade', $modalidade, 250);
        ...
        $this->form->setData( TSession::getValue('Aerobico_filter_data') );
        $this->form->addQuickAction( _t('Find'), new TAction(array($this, 'onSearch')), 'ico_find.png');
        $this->form->addQuickAction( _t('New'),  new TAction(array('TreinamentoAerobico', 'onEdit')), 'ico_new.png');
        ...
        $id = $this->datagrid->addQuickColumn('ID', 'codAerobico', 'center', 50);
        ...
        $edit_action   = new TDataGridAction(array('TreinamentoAerobicoForm', 'onEdit'));
        $delete_action = new TDataGridAction(array($this, 'onDelete'));
        
        // add the actions to the datagrid
        $this->datagrid->addQuickAction(_t('Edit'), $edit_action, 'codAerobico', 'ico_edit.png');
        $this->datagrid->addQuickAction(_t('Delete'), $delete_action, 'codAerobico', 'ico_delete.png');
        ...
        $container = new TVBox;
        $container->add(new TXMLBreadCrumb('menu.xml', 'PesquisaTreinamentoAerobico'));
