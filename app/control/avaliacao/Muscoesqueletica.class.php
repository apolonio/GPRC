 ...
 */
class Muscoesqueletica extends TStandardForm
{
    protected $form;     
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $dataFr= new TDate('dataFM');
        $dataFr->setMask('dd/mm/yyyy');
        $dataFr->setDatabaseMask('yyyy-mm-dd');
        ...
        $this->form->addQuickField('Data',$dataFr,100);
    ...
    public function onSave()
    {
        try
        {
            ...
            $category = $this->form->getData('AvaliacaoMuscoesqueletica');
            
            $category->store();
            
            TTransaction::close();
            
            new TMessage('info', 'Avaliação Força Muscoesquelética cadastrada com Sucesso!');
