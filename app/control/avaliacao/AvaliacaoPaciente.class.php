 ...
 */
class AvaliacaoPaciente extends TStandardForm
{
    protected $form;     
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Avaliação Clínica do Paciente');
...
//Medicamneto
    ...
    public function onSave()
    {
        try
        {
            ...
            $category = $this->form->getData('AvaliacaoClinica');
            
            $category->store();
            
            TTransaction::close();
            
            new TMessage('info', 'Avaliação Clínica cadastrada com Sucesso!');
