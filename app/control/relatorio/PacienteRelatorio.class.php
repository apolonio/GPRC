...
class PacienteRelatorio extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->setFields(array($nome,$sexo,$dataNascimento,$email,$peso,$estatura,$imc,$output_type,$save_button));
                    ...
                    foreach ($customers as $customer)
                    {
                      ...
                      //  $style = $colour ? 'datap' : 'datai';
                        ...
                        $tr->addCell($customer->estatura, 'center', $style);
                         $tr->addCell($customer->imc, 'center', $style);
